    ...
    public class UICreatePlayerStatisten : MonoBehaviour
    {
        ...
        public void Start()
        {
            ...
            StatistenModels.ForEach((GameObject Model) =>
            {
                ...
                CamOb.transform.position = (CamOffset /OnlineSel.res) + Ob.transform.position;
                ...
                RenderTexture RT = new RenderTexture((int)((248*2)/OnlineSel.res),(int)( (175*2) / OnlineSel.res), 16, RenderTextureFormat.ARGB32);
                RT.Create();
